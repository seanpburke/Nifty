 ...
 *
 * $Id: nft_win32.c,v 1.7 2004/03/11 19:42:22 sean Exp $
 *********************************************************************** 
 */

/*
 * This code will only build on WIN32.
 */ 
#ifdef WIN32
 ...
 */
#define PError(funcName) \
	fprintf(stderr, "Error: %s returned error %d\n", funcName, GetLastError());
...
/*
 * pthread_create - create a new WIN32 thread.
 */
...
int pthread_join(pthread_t h_thread, void ** val_p)
{
    ...
    {
	/* We are not sure that the thread does not exist,
	 * so return EINVAL rather than ESRCH.
	 */
	return EINVAL;
    }
...
{
    /* This thread attribute is ignored.
     */
...
/* Mutex Functions implementation
 */
...
int pthread_mutex_trylock (pthread_mutex_t *mp)
{
    ...
    case WAIT_TIMEOUT:
	return EBUSY;	/* Lock already held */
    default:
	PError("WaitForSingleObject");
	return EFAULT;
    }
