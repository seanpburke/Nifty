 ...
 *
 *  Note that you will usually get EINVAL if the queue has been shut down.
 *  ESHUTDOWN is returned only when the shutdown occurs while waiting.
 */
...
void * nft_queue_dequeue(nft_queue * q, int timeout);
